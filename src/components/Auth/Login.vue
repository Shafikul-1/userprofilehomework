...
const loginInfo = users().loginInfo
const loginFRSubmit = users().loginFRSubmit
const auth = users().auth
const notauth = users().notauth
</script>
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            ...
            <div class="w-full py-6 z-20">
                ...
                <div class="py-6 space-x-2">
                    <span @click="auth" class="w-10 h-10 items-center justify-center inline-flex rounded-full font-bold text-lg border-2 border-white">f</span>
                    <span @click="notauth" class="w-10 h-10 items-center justify-center inline-flex rounded-full font-bold text-lg border-2 border-white">G+</span>
                ...
                <form @submit.prevent="loginFRSubmit" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    <div class="pb-2 pt-4">
                        <input v-model="loginInfo.name" type="text" name="name" id="name" placeholder="Enter Your User Name" class="block w-full p-4 text-lg rounded-sm bg-black">
                    </div>
                    <div class="pb-2 pt-4">
                        <input v-model="loginInfo.email" type="email" name="email" id="email" placeholder="Enter Your Email" class="block w-full p-4 text-lg rounded-sm bg-black">
                    </div>
                    <div class="pb-2 pt-4">
                        <input v-model="loginInfo.pass" class="block w-full p-4 text-lg rounded-sm bg-black" type="password" name="password" id="password" placeholder="Enter Your Password">
                    </div>
                    <div class="text-right text-gray-400  ">
                        <div class="flex justify-between">
                            <router-link to="/signup" class="hover:text-gray-100 hover:underline">Or Sign Up</router-link>
                            <a href="#" class="hover:text-gray-100 hover:underline">Forgot your password?</a>
                        </div>
                    </div>
